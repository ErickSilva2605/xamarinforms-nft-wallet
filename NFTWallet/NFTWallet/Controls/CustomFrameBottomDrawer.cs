...
namespace NFTWallet.Controls
{
    ...
    public class CustomFrameBottomDrawer : Frame
    {
        #region Fields
        ...
        public static readonly BindableProperty IsOpenProperty = BindableProperty.Create(
            ...
            declaringType: typeof(CustomFrameBottomDrawer),
        ...
        /// Constructor
        /// </summary>
        public CustomFrameBottomDrawer()
        {
        ...
        {
            if (newValue is bool isOpened && bindable is CustomFrameBottomDrawer drawer)
            {
        ...
        {
            if (newValue is double expandValue && bindable is CustomFrameBottomDrawer drawer)
            {
                if (!drawer.isDragging)
                {
